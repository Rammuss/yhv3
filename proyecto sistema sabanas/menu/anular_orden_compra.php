...
$id_orden_compra = pg_escape_string($id_orden_compra);

// Preparar la consulta SQL para actualizar el estado
$sql = "
    UPDATE public.ordenes_compra
    SET estado_orden = 'Rechazado'
    WHERE id_orden_compra = $1
";

// Preparar la consulta
$result = pg_prepare($conn, "update_orden_compra", $sql);
if (!$result) {
...
$result = pg_execute($conn, "update_orden_compra", array($id_orden_compra));
