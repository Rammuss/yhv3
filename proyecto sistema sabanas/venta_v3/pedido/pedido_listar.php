...
require_once __DIR__.'/../../conexion/configv2.php'; // <-- ajustá si tu path difiere

// ---- Helpers ----
function e($s){ return htmlspecialchars((string)$s, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); }
$ESTADOS = ['pendiente','facturado','anulado']; // podés agregar más si usás otros
...
if ($q !== '') {
  // Buscar por nombre/apellido/ruc_ci
...
<div class="wrap">
  ...
  <div class="card">
              ...
              <td>
                <div class="right">
                  ...
                  <?php if (strtolower($r['estado'])==='pendiente'): ?>
                    <button class="btn btn-danger" onclick="anular(<?= (int)$r['id_pedido'] ?>)">Anular</button>
                  <?php endif; ?>
                </div>
              </td>
            </tr>
    ...
    <div class="pager">
      <?php
        // construir query string sin page
...
function toast(msg, ok=true){
  ...
  clearTimeout(window.__t); window.__t=setTimeout(()=>t.style.display='none', 3000);
}
